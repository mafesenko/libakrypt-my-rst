...
*Пример  4 - ини*
	...
	3. По OID (уникальному идентификатору) алгоритма:
::
...
В библиотеке описано 12 функций для создания контекста алгоритма аутентифицированного шифрования. Коротко рассмотрим каждую из них.
